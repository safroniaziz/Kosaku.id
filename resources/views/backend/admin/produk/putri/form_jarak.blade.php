<div class="form-group col-md-6">
    ...
    <input type="number" name="jarak_damkar" value="{{ old('jarak_damkar') }}" class="form-control">
...
<div class="form-group col-md-6">
    ...
    <input type="number" name="jarak_rs_terdekat" value="{{ old('jarak_rs_terdekat') }}" class="form-control">
...
<div class="form-group col-md-6">
    ...
    <input type="number" name="jarak_pusat_kota" value="{{ old('jarak_pusat_kota') }}" class="form-control">
...
<div class="form-group col-md-6">
    ...
    <input type="number" name="jarak_polisi_terdekat" value="{{ old('jarak_polisi_terdekat') }}" class="form-control">
...
<div class="form-group col-md-6">
    ...
    <input type="number" name="jarak_puskesmas" value="{{ old('jarak_puskesmas') }}" class="form-control">
...
<div class="form-group col-md-6">
    ...
    <input type="number" name="jarak_pasar" value="{{ old('jarak_pasar') }}" class="form-control">
