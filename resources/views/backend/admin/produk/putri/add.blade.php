            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <form action="{{ route('admin.produk_putri.post') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-12">
                        ...
                        @include('backend/admin/produk/putri.form_wilayah')

                        <div class="col-md-12 mb-2 mt-2">
                            <strong>Langkah 2: Masukan Kelengkapan Data Produk</strong>
                        </div>
                        @include('backend/admin/produk/putri.form_kelengkapan')

                        <div class="col-md-12 mb-2 mt-2">
                            <strong>Langkah 3: Masukan Kelengkapan Fasilitas</strong>
                        </div>

                        @include('backend/admin/produk/putri.form_fasilitas')

                        <div class="col-md-12 mb-2 mt-2">
                            <strong>Langkah 4: Masukan Jarak Dengan Lokasi Darurat</strong>
                        </div>
                        @include('backend/admin/produk/putri.form_jarak')
                    </div>
