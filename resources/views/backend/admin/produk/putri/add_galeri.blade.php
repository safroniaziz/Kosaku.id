    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <form action="{{ route('admin.produk_putri.galeri_post',[$id,$slug]) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-12">
                        ...
                        @if ($errors)
                            <small class="form-text text-danger">{{ $errors->first('foto_detail') }}</small>
                        @endif
                        @include('backend/admin/produk/putri.form_foto')
                    </div>
                    <div class="col-md-12 text-center">
                        <hr style="width: 50%" class="mt-0">
                        <a href="{{ route('admin.produk_putri.detail',[$id,$slug]) }}" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
