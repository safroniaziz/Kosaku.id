            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-primary alert-block" id="keterangan">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                        <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Berikut adalah semua data slider yang tersedia, silahkan tambahkan slider baru jika diperlukan !!
                    </div>
                </div>
                <div class="col-md-12">
                    <a href="{{ route('admin.slider.add') }}" style="color:white; cursor:pointer;" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp; Tambah Slider</a>
                </div>
                <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            @foreach ($sliders as $slider)
                                <tr>
                                    <td> {{ $no++ }} </td>
                                    <td>
                                        <img src="{{ asset('storage/'.$slider->gambar) }}" style="width:100px;" alt="">
                                    </td>
                                    <td> {{ $slider->title }} </td>
                                    <td> {{ $slider->slogan }} </td>
                                    <td>
                                        <a onclick="hapusSlider({{ $slider->id }})" class="btn btn-danger btn-sm text-white" style="cursor: pointer;"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="modal modal-danger fade" id="modalhapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            Apakah anda yakin akan menghapus gambar slider ?
                            </div>
