    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <form action="{{ route('admin.slider.post') }}" enctype="multipart/form-data" method="POST">
                    {{ csrf_field() }} {{ method_field('POST') }}
                    <div class="col-md-12">
                        <div class="col-md-12 mb-2 mt-2">
                            <strong>Langkah 1: Masukan Gambar Slider Yang Diinginkan</strong>
                        </div>
                        
                        @include('backend/admin/slider/form')
                    </div>
                    <div class="col-md-12 text-center">
                        <hr style="width: 50%" class="mt-0">
                        <a href="{{ route('admin.slider') }}" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
