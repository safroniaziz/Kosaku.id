        ...
        <div class="left_col scroll-view" style="background: #013C62 !important;">
            ...
            <div class="profile clearfix">
                <div class="profile_pic">
                  <img src="{{ asset('assets/backend/images/logo.png') }}"style="width:70%; background:#fff; margin-left:15%;z-index:1000; position:inherit;margin-top:20px;border: 1px solid rgba(52,73,94,0.44);padding: 4px;border-radius:50%;filter:drop-shadow(0px 1px 5px #fff);" alt="..." class="img-circle profile_img">
                </div>
            ...
            <div class="nav_menu" style="float:left; background:#fff; border-bottom: 2px solid #e7eaec; margin-bottom:10px; width:100%; padding:1px 0px;">
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="javascript:;">Kunjungi Website</a>
                        <a class="dropdown-item text-danger" href="login.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                        </div>
                  </li>
                </ul>
              </nav>
