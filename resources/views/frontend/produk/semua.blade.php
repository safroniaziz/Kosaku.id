            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
               ...
               <!-- Option bar end -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 wow fadeInUp delay-03s">
                        <!-- Property start -->
                        <div class="property">
                            <!-- Property img -->
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 wow fadeInUp delay-03s">
                        ...
                        <div class="property">
                            ...
                            <div class="property-img">
                                ...
                                <div class="property-price">
                                    <b style="color:black; font-size:12px; text-decoration:line-through">Rp.{{ number_format($all->harga_sewa) }}</b>
                                    <b style="color:black; font-size:12px;">Rp.{{ number_format($all->harga_sewa - $all->diskon) }}</b>
                                </div>
